 ...
 *
 * Commands: login, whoami, quick, eval, config, init
 * Program and commands are at module scope so tests can import { program }.
 */
...
// ═══════════════════════════════════════════════════════════════════
//  Program definition (module scope — importable by tests)
// ═══════════════════════════════════════════════════════════════════
